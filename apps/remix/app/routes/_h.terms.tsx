  ...
  return (
    <div className="mx-10 mt-24 text-white">
      <div className="max-w-[1400px] ">
        ...
        <p className="mt-8">
          Welcome to illsky.dpdns.org! These Terms of Service ("Terms") govern your
        ...
        <p className="mt-4">
          illsky.dpdns.org is a minimalistic temporary email service that allows you to
          ...
          illsky.dpdns.org operates on the Cloudflare network, guaranteeing a
        ...
        <p className="mt-4">
          2.1 Availability: Please note that illsky.dpdns.org is not available in China
          Mainland. We apologize for any inconvenience caused.
        </p>
        <p className="mt-4">
          2.2 Copyright: All copyrights related to illsky.dpdns.org and its services
          belong to illsky.dpdns.org. You may not copy, reproduce, distribute, modify,
          or create derivative works of illsky.dpdns.org or any part thereof without
          explicit permission from illsky.dpdns.org.
        </p>
        ...
        <p className="mt-4">
          ...
          personal information to use illsky.dpdns.org. However, you are solely
          responsible for maintaining the confidentiality of any temporary email
          addresses generated through our service.
        </p>
        <p className="mt-4">
          3.2 Prohibited Activities: While using illsky.dpdns.org, you agree not to
        ...
        <p className="mt-4">
          illsky.dpdns.org is provided on an "as is" and "as available" basis. We do
          not warrant that our services will be uninterrupted, error-free, or
          secure. Your use of illsky.dpdns.org is at your own risk, and we disclaim all
        ...
        <p className="mt-4">
          To the maximum extent permitted by law, in no event shall illsky.dpdns.org or
          ...
          from your access to or use of illsky.dpdns.org or any content or services
          provided through illsky.dpdns.org.
        </p>
        ...
        <p className="mt-4">
          ...
          posting. Your continued use of illsky.dpdns.org after the posting of any
        ...
        <p className="mt-4">
          ...
          laws of the jurisdiction where illsky.dpdns.org is located. Any disputes
        ...
        <p className="mt-8">Last updated: 2025-01-05</p>
      </div>
    </div>
  );
}
