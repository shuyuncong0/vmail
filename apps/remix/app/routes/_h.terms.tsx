  ...
  return (
    <div className="mx-10 mt-24 text-white">
      <div className="max-w-[1400px] ">
        ...
        <p className="mt-8">
          Welcome to illsky.us.kg! These Terms of Service ("Terms") govern your
        ...
        <p className="mt-4">
          illsky.us.kg is a minimalistic temporary email service that allows you to
          ...
          illsky.us.kg operates on the Cloudflare network, guaranteeing a
        ...
        <p className="mt-4">
          2.1 Availability: Please note that illsky.us.kg is not available in China
          Mainland. We apologize for any inconvenience caused.
        </p>
        <p className="mt-4">
          2.2 Copyright: All copyrights related to illsky.us.kg and its services
          belong to illsky.us.kg. You may not copy, reproduce, distribute, modify,
          or create derivative works of illsky.us.kg or any part thereof without
          explicit permission from illsky.us.kg.
        </p>
        ...
        <p className="mt-4">
          ...
          personal information to use illsky.us.kg. However, you are solely
          responsible for maintaining the confidentiality of any temporary email
          addresses generated through our service.
        </p>
        <p className="mt-4">
          3.2 Prohibited Activities: While using illsky.us.kg, you agree not to
        ...
        <p className="mt-4">
          illsky.us.kg is provided on an "as is" and "as available" basis. We do
          not warrant that our services will be uninterrupted, error-free, or
          secure. Your use of illsky.us.kg is at your own risk, and we disclaim all
        ...
        <p className="mt-4">
          To the maximum extent permitted by law, in no event shall illsky.us.kg or
          ...
          from your access to or use of illsky.us.kg or any content or services
          provided through illsky.us.kg.
        </p>
        ...
        <p className="mt-4">
          ...
          posting. Your continued use of illsky.us.kg after the posting of any
        ...
        <p className="mt-4">
          ...
          laws of the jurisdiction where illsky.us.kg is located. Any disputes
